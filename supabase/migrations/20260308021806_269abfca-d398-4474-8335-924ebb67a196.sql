-- Fix ALL SELECT RLS policies to be PERMISSIVE so admin can see all data
-- and users can see their own data (OR logic instead of AND)

-- ═══ saved_videos ═══
DROP POLICY IF EXISTS "Admins can view all videos" ON public.saved_videos;
DROP POLICY IF EXISTS "Users can view their own videos" ON public.saved_videos;
DROP POLICY IF EXISTS "Users can insert their own videos" ON public.saved_videos;
DROP POLICY IF EXISTS "Users can update their own videos" ON public.saved_videos;
DROP POLICY IF EXISTS "Users can delete their own videos" ON public.saved_videos;
...
-- ═══ favorite_surahs ═══
DROP POLICY IF EXISTS "Users can view their own favorites" ON public.favorite_surahs;
DROP POLICY IF EXISTS "Users can insert their own favorites" ON public.favorite_surahs;
DROP POLICY IF EXISTS "Users can delete their own favorites" ON public.favorite_surahs;
